    ...
    items: [
        ...
        },
        {
            ...
            activeLinks: [
                ...
                "/src/pages/errors/maintenance.html",
            ...
            subMenus: [
                ...
                { name: "404 Not Found", link: "/src/pages/errors/404.html" },
                { name: "500 Server Error", link: "/src/pages/errors/500.html" },
                { name: "Maintenance", link: "/src/pages/errors/maintenance.html" },
                { name: "Inbox", link: "/src/pages/inbox.html" },
                { name: "Calendar", link: "/src/pages/calendar.html" },
                { name: "Kanban", link: "/src/pages/kanban.html" },
                { name: "Invoice", link: "/src/pages/invoice.html" },
                { name: "Users", link: "/src/pages/users.html" },
            ],
        },
        {
            label: "Settings",
